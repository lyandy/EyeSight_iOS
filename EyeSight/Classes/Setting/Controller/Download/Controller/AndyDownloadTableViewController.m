//
//  AndyDownloadTableViewController.m
//  EyeSight
//
...
@implementation AndyDownloadTableViewController
...
- (void)combineData
{
    self.videoList = XAppDelegate.downloadVideoList;
...
{
    AndyDownloadVideoCell *cell = [AndyDownloadVideoCell cellWithTableView:tableView];
