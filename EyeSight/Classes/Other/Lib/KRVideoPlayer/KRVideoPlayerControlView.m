...
- (void)layoutSubviews
{
    ...
    NSLog(@"%f, %f, %f, %f", self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y, self.titleLabel.frame.size.width, self.titleLabel.frame.size.height);
...
- (UIButton *)qualityButton
{
    if (_qualityButton == nil)
    {
        ...
        [_qualityButton setTitleColor:AndyColor(150, 150, 150, 1.0) forState:UIControlStateDisabled];
